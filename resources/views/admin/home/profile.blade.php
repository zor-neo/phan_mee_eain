                    ...
                    <div class="row align-items-center g-5">
                        <div class="card" style="width: 40rem">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><i class="fa-solid fa-quote-left"></i> {{ Auth::user()->bio }}<i
                                        class="fa-solid fa-quote-right"></i> </p>
                            </div>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><i class="fa-solid fa-phone me-3"></i> {{ Auth::user()->phone }}
                                </li>
                                <li class="list-group-item"><i class="fa-regular fa-envelope me-3"></i>
                                    {{ Auth::user()->email }}</li>
                                <li class="list-group-item"><i class="fa-solid fa-map-location-dot me-3"></i>
