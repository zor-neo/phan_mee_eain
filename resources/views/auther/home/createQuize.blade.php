        ...
        <section class="p-4 p-md-5 flex-grow-1">
            <div class="sw-panel mx-auto" style="max-width: 760px;">
                ...
                <h1 class="fs-3 fw-bold text-dark mb-3">
                    <i class="fas fa-question-circle text-purple me-2"></i> Create Quiz Test
                </h1>
                <p class="sw-muted mb-4">
                    Quiz creation is planned for a future version of Phan Mee Eain. For the current release, authors can
                    publish learning content and include supporting files for users to study.
                </p>
